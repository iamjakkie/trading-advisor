...
#     # Ensure each chunk is within the max token limit
#     chunks = []
...
# books_summary = " ".join([summarizer(chunk, max_length=512, min_length=30, do_sample=False, truncation=True)[0]['summary_text'] for chunk in book_chunks])
